...
description: 维护 append-only 执行流水账：在 EXEC_LOG.md 和 dated 计划文件文末双追加日志。当步骤开始、完成、遇到问题、做出重要决策时触发。当用户说"记一下"、"追加日志"、"记录现场"、"写日志"、"日志"、"刚才的报错记下来"、"备忘一下"时触发。不用于：修改计划结构、改变状态、恢复断点。
---
