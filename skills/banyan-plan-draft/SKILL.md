...
description: 将需求拆解为可执行的分阶段计划并初始化双轨文件（TASK_PLAN.md + dated 计划文件）。当用户输入需求、想法、或提出"制定计划"、"拆解任务"、"分析需求"、"规划方案"、"起草计划"、"怎么做"、"帮我规划"时触发。用户说"先出个方案再动手"、"帮我理一下怎么做"、"从零开始做"、"给个步骤"时同样触发。不用于：修改代码、运行命令、执行门禁、追加日志、恢复断点。
---
